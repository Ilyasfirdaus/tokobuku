...
class Welcome extends CI_Controller {
	...
	{
		$data['DataPencarianBuku']	=$this->MSudi->GetData('penerbiit');
	...
	public function penerbitInsert()
	{
		...
		$this->MSudi->AddData('penerbiit', $add);
	...
	public function penerbitUpdate()
	{
		...
		$this->MSudi->UpdateData('penerbiit','id_penerbit',$id_penerbit, $update);
		redirect(site_url('Welcome/penerbit'));
	}
	...
	public function penerbitDelete()
	{
		...
		$this->MSudi->DeleteData('penerbiit','id_penerbit', $id_penerbit);
		redirect(site_url('Welcome/penerbit'));
	}
